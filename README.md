...
*   **CSS3**: Custom keyframe animations (`twinkle`, `pulse`), CSS radial gradients for stars, and a mobile-friendly grid layout.
...
1.  Visit [api.nasa.gov](https://api.nasa.gov/) and sign up for a free developer API key.
